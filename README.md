HelloWorld2. VBNet Tutorials. DotNet Core Platform. Simple Input/Output. Console Application.
...
HelloWorld2. Занятия по VB.Net. Платформа DotNet Core. Простой Ввод/Вывод. Консольное приложение.
